...
OUTPUT_PATH=${MODEL_DIR}-merge/math-code/${METHOD}-${REDUCE_NON_DIAG_A}-OpenMathInstruct2_SelfOSSInstructSC2
...
python src/merge.py \
    ...
    --datasets "{'math': ['output/OLMoE-1B-7B-0125/data/OpenMathInstruct2.jsonl'], 'code': ['output/OLMoE-1B-7B-0125/data/SelfOSSInstructSC2.jsonl']}" \
